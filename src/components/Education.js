    ...
    <div className="my-64">
      ...
      <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4 xs:ml-2">
          ...
          />
          <Details type="Student in Computer Science" time="2024-now" place="Universitas Pendidikan Indonesia" info="Relevant courses included  Algorithms and Computer Systems Engineering." />
        </ul>
      </div>
    </div>
  );
